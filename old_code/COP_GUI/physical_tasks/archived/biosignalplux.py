    ...
    def onRawFrame(self, nSeq, data):
        ...
        if PluxLoggingFlag:
            if plux_file is not None:
                ...
                plux_file.write("{0:s},{1:f},{2:f},{3:f},{4:f},{5:f}\n".format(timestr, data[0], data[1], data[2], data[3], data[4]))
            else:
...
def PluxDataFile(path):
    ...
    try:
        ...
        plux_file.write("{0},{1},{2},{3},{4},{5}\n".format('Time', 'ECG', 'GSR', 'Breathing', 'EMG', 'PulseOx'))
